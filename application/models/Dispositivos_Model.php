    ...
    if ($count > 0) {
      ...
      if ($MH->num_rows() > 0) {
        ...
        $output .= '<br><br><br><p style="font-size:24px; margin-left:350px;">RUTA: <b>' . STRTOUPPER($data->row()->Nombre_Ruta) . ' </b><br><br>
                      ...
                      MOTIVO ENTREGA:  <b>' . STRTOUPPER($data->row()->motivo_entrega) . '</b><br><br>
