...
<body>
    ...
    <div class="page-wrapper chiller-theme toggled">
        <main class="page-content">
            <section id="hero" class="wow fadeIn">
                ...
                <h1 style="margin-top:1%">Impresoras</h1><br>
                ...
                <div style="display: flex; justify-content:space-between">
                    ...
                    <div style="width:50%;">
                        <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#Modal_Marca"> <i class="fas fa-plus"></i> Marca</button>
                        <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#Modal_Modelo"><i class="fas fa-plus"></i> Modelo</button>
                        <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#Modal_Entrega"><i class="far fa-check-circle"></i> Entrega Impresora <button>
                    ...
                    <div style=" width:50%;">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="x" class="col-sm-2 col-form-label">Distribuidora</label>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-2">
                                <button class="btn btn-outline-primary" id="consult_impr"> <i class="fas fa-search"></i></button>
                ...
                <div class="tabla_impr float-right">
                </div>
    ...
    <script>
                ...
                success: function(respuesta) {
                    ...
                    for (var i = 0; i < registros.length; i++) {
                        html += "<tr><td style='display:none;'>" + registros[i]["Id_Ruta"] +
                            ...
                            "</td><td>" + registros[i]["nombre_marca"] + "<br> " + registros[i]["nombre_modelo"] + registros[i]["codigo_impresora"] +
        ...
        $('#consult_impr').click(function() {
            ...
            $.ajax({
                ...
                success: function(respuesta) {
                    ...
                    html = "<table class='table'>";
                    html += "<tr><th>Distribuidora</th><th>Ruta</th><th>Impresora</th><th>Activo Fijo</th><th> N de Serie</th><th >Codigo Impresora</th><th >Editar</th><th>Baja/Alta</th></tr>";
                    html += "<tbody>";
        ...
        function ConsultarPDF() {
            //Muestra listado pdf de impresoras entregadas 
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/Impresoras/Consultar_PDF_ruta",
                method: "POST",
                data : {
                    Id_ruta: $("#bruta").val()
                },
