...
<script type="text/javascript">
                        ...
                        series: [{
                            ...
                            },
                            {
                                ...
                                data: [
                                    ...
                                    {
                                        value: parseInt(data[1][1]) + parseInt(data[1][2]) + parseInt(data[1][3]),
                                        name: 'CLIENTES NO ACTUALIZADOS'
                                    },
                                    {
                                        value: parseInt(data[2][1]) + parseInt(data[2][2]) + parseInt(data[2][3]),
                                        name: 'CLIENTES ACTUALIZADOS'
                                    },
    ...
    function agregar_clientes() {
        ...
        if (document.getElementById("excel_file_client").files.length == 0) {
            swal.fire({
                title: 'Adjunte un archivo para cargar',
                type: 'error'
            });
            return false;
